...
function generateStructureFromMap(pieceStart, structureType) {
    ...
    if (isLevelOverworld) {
        ...
        //> Generate structure from predefined map for underground
        switch (structureType) {
            case 0:
                this.misteryBlocksGroup.add(this.add.sprite(pieceStart, screenHeight - (platformHeight * 1.9), 'mistery-block').setScale(screenHeight / 345).setOrigin(2.5, 0.5));
                this.misteryBlocksGroup.add(this.add.sprite(pieceStart, screenHeight - (platformHeight * 1.9), 'mistery-block').setScale(screenHeight / 345).setOrigin(1.5, 0.5));
                ...
                break;
            case 1:
                this.blocksGroup.add(this.add.tileSprite(pieceStart, screenHeight - platformHeight, 16, 16, 'block2').setScale(screenHeight / 345).setOrigin(2.5, 1));
                this.blocksGroup.add(this.add.tileSprite(pieceStart, screenHeight - platformHeight, 16, 16, 'block2').setScale(screenHeight / 345).setOrigin(1.5, 1));
                this.blocksGroup.add(this.add.tileSprite(pieceStart, screenHeight - platformHeight, 16, 16, 'block2').setScale(screenHeight / 345).setOrigin(0.5, 1));
                this.blocksGroup.add(this.add.tileSprite(pieceStart, screenHeight - platformHeight, 16, 16, 'block2').setScale(screenHeight / 345).setOrigin(-0.5, 1));
                this.blocksGroup.add(this.add.tileSprite(pieceStart, screenHeight - platformHeight, 16, 16, 'block2').setScale(screenHeight / 345).setOrigin(-1.5, 1));
                break;
            case 2:
